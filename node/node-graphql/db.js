...
const products = [
	...
	},
	{
		...
		"description": "Easy upgrade for faster boot up, shutdown, application load and response " +
			"(As compared to 5400 RPM SATA 2.5” hard drive; " +
			"Based on published specifications and internal benchmarking tests using PCMark vantage scores) " +
			"Boosts burst write performance, making it ideal for typical PC workloads " +
			"The perfect balance of performance and reliability Read/write speeds of up to 535MB/s/450MB/s (Based on internal testing; " +
	...
	},
	{
		...
		"description": "21. 5 inches Full HD (1920 x 1080) widescreen IPS display And Radeon free Sync technology. " +
			"No compatibility for VESA Mount Refresh Rate: 75Hz - Using HDMI port Zero-frame design | ultra-thin | " +
			"4ms response time | IPS panel Aspect ratio - 16: 9. Color Supported - 16. 7 million colors. " +
			"Brightness - 250 nit Tilt angle -5 degree to 15 degree. " +
			"Horizontal viewing angle-178 degree. Vertical viewing angle-178 degree 75 hertz",
		"categoryId": 3,
	},
	{
	...
	},
	{
		...
		"description": "Note:The Jackets is US standard size, Please choose size as your usual wear Material: 100% Polyester; Detachable Liner Fabric: Warm Fleece. " +
			"Detachable Functional Liner: Skin Friendly, Lightweigt and Warm.Stand Collar Liner jacket, keep you warm in cold weather. " +
			"Zippered Pockets: 2 Zippered Hand Pockets, 2 Zippered Pockets on Chest (enough to keep cards or keys)and 1 Hidden Pocket Inside.Zippered Hand Pockets and " +
			"Hidden Pocket keep your things secure. Humanized Design: Adjustable and Detachable Hood and Adjustable cuff to prevent the wind and water,for a comfortable fit. " +
			"3 in 1 Detachable Design provide more convenience, you can separate the coat and inner as needed, or wear it together. " +
	...
	},
	{
		...
		"description": "100% POLYURETHANE(shell) 100% POLYESTER(lining) 75% POLYESTER 25% COTTON (SWEATER), " +
			...
			"Button detail on waist / Detail stitching at sides, HAND WASH ONLY / DO NOT BLEACH / LINE DRY / DO NOT IRON",
		"categoryId": 4,
	},
	{
		"id": 17,
		...
		"description": "Lightweight perfet for trip or casual wear---Long sleeve with hooded, adjustable drawstring waist design. " +
			"Button and zipper front closure raincoat, fully stripes Lined and The Raincoat has 2 side pockets are a good size to hold all kinds of things, " +
			"it covers the hips, and the hood is generous but doesn't overdo it.Attached Cotton Lined Hood with Adjustable Drawstrings give it a real styled look.",
		"categoryId": 4,
	},
	{
		"id": 18,
...
const users = [
	{
		...
		"first_name": "Arron",
		"last_name": "D'Amore",
		"username": "arron.d'amore",
		"email": "arron.d'amore@email.com",
		"phone_number": "+15166622063",
	...
	},
	{
		...
		"first_name": "Scotty",
		"last_name": "Ankunding",
		"username": "scotty.ankunding",
		"email": "scotty.ankunding@email.com",
		"phone_number": "+12124654114",
	...
	},
	{
		...
		"first_name": "Chadwick",
		"last_name": "Runte",
		"username": "chadwick.runte",
		"email": "chadwick.runte@email.com",
		"phone_number": "+13152949456",
	...
	},
	{
		...
		"first_name": "Janetta",
		"last_name": "Kreiger",
		"username": "janetta.kreiger",
		"email": "janetta.kreiger@email.com",
		"phone_number": "+13156782827",
	...
	},
	{
		...
		"first_name": "Clint",
		"last_name": "Friesen",
		"username": "clint.friesen",
		"email": "clint.friesen@email.com",
		"phone_number": "+13475751217",
...
const orders = [
	{
		"id": 1,
		"userId": 2,
		"created": '2021-01-19 10:23:54',
		"productIds": [2, 5, 10, 17]
	},
	{
		"id": 2,
		"userId": 1,
		"created": '2021-02-01 12:04:27',
		"productIds": [1, 2, 6, 11, 12, 20]
	},
	{
		"id": 3,
		"userId": 5,
		"created": '2021-02-01 14:02:35',
		"productIds": [7, 8, 11]
	},
	{
		"id": 4,
		"userId": 5,
		"created": '2021-02-04 19:17:56',
		"productIds": [3, 19]
	},
	{
		"id": 5,
		"userId": 3,
		"created": '2021-02-05 21:47:10',
		"productIds": [11, 12, 15, 18, 20]
	}
];
